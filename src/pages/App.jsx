  ...
  return (
    <>
      ...
      <header className="fixed w-full h-fit flex flex-col z-15">
        <nav className="w-full h-fit px-12 py-6 flex">
          <div ref={navbarRef} className={`w-full h-fit flex items-center flex-row font-semibold transition-all duration-300
          ${isDark ? "text-white" : "text-black"}`}>
            <a href="/" className="w-full leading-[140%] text-lg">Veste</a>
            <ul className="w-fit h-fit text-base flex flex-row text-[#757575] gap-x-8">
            ...
            <div className="w-full flex justify-end">
              <a href="/" className={`w-fit h-fit text-sm py-2 px-4
      ...
      <main>
        <section className="w-full h-fit pt-[86px]">
          <div className="relative w-full h-fit bg-grid-pattern flex-1 px-12 pt-6 pb-12 overflow-hidden">
            <div className="w-full h-[630px] flex flex-col items-end">
              ...
              <div className="w-full h-72 flex flex-row justify-between z-10">
                <div className="w-max h-full">
                  <div className="w-[480px] h-full flex flex-col justify-between">
                    <SlideUp delayNum={0.8}>
                      <p className="w-72 h-fit text-base font-medium leading-[140%] text-[#757575]">
                    ...
                    <SlideUp delayNum={0.8}>
                      <h2 className="w-64 h-fit text-[#757575] text-5xl font-semibold">
                        CHANEL FOR FW25
                      </h2>
                    </SlideUp>
                  </div>
                ...
                <div className="w-fit h-full flex flex-col text-right justify-between">
                  <SlideDown delayNum={0.8}>
                    <p className="leading-[140%] text-lg font-semibold tracking-[0px]">ft. Jennie</p>
                  </SlideDown>
                  <a href="w-fit h-fit flex flex-row">
                    <SlideUp delayNum={0.8}>
                      <div className="w-48 h-32 bg-gray-300 overflow-hidden">
                        <img src="/public/images/herocard.png"
                        className="w-full h-fit" alt="herocard" />
                      </div>
                      <div className="w-full h-fit pt-3 text-base font-medium flex flex-row justify-between items-center text-black">
            ...
            <div className="absolute w-full flex-1 top-0 flex justify-center translate-y-[32px] translate-x-[-44px] z-1">
              <img src="/public/images/hero.png"
              className="absolute top-0 z-5 w-[1000px]" alt="" />
            </div>
          </div>
        </section>
        <section ref={sectionRefs[0]} className="w-full h-fit bg-black text-white p-12 flex flex-row gap-12">
          <div className="w-full flex flex-col gap-20">
            <h2 className="w-[640px] text-5xl leading-[120%] font-semibold">
              <span className="block">THE SINGLE</span>
              <span className="block">MOST—DISCUSSED</span>
            </h2>
            <div className="w-full h-[640px] flex flex-col gap-8">
              <div className="w-full h-fit flex flex-row justify-between">
                <h3 className="w-64 h-fit leading-[110%] text-2xl font-semibold">
                  The Best Celebrity Halloween Costumes of 2025
                </h3>
                <p className="w-72 h-fit leading-[140%] text-base font-normal tracking-[0px] text-justify">
              ...
              <div className="w-full h-full overflow-hidden">
                ...
                className="w-full translate-y-[-64px]" alt="" />
                </Blink>
              </div>
            </div>
          </div>
          <div className="w-96 h-auto flex flex-col justify-between">
            ...
            <button className="w-full py-2 text-black bg-white justify-center text-base font-medium 
            hover:bg-black hover:text-white border border-white duration-300 transition-all cursor-pointer">View More</button>
          </div>
        </section>
        <section className="w-full h-fit p-12 flex flex-col gap-8">
          <div className="w-full h-fit flex flex-row justify-between">
            <h4 className="text-lg font-semibold">RECENT EDITORIAL UPDATES</h4>
            <button className="w-fit px-10 py-2 text-white bg-black justify-center text-base font-medium 
            hover:bg-transparent hover:text-black border border-black duration-300 transition-all cursor-pointer">View More</button>
          </div>
          <div className="w-full h-fit flex flex-row gap-12">
            <div className="w-full h-auto flex flex-col gap-10">
              <h3 className="w-96 h-fit text-5xl leading-[120%] font-semibold">WHAT THE NEW LOOK IS</h3>
              <a href="/" className="w-full h-[640px] flex flex-col gap-5">
                <div className="w-full h-full overflow-hidden">
                  <Blink delayNum={0.2}>
                ...
                <p className="text-base font-medium leading-[120%]">Thom Browne Takes Us to the Country This Winter</p>
              </a>
              <a href="/" className="w-full h-full flex flex-col gap-5">
                <div className="w-full h-[414px] overflow-hidden">
                    <Blink delayNum={0.3}>
            ...
            <div className="w-full h-full flex flex-col gap-10">
              <a href="/" className="w-full h-fit flex flex-col gap-5">
        ...
        <section className="w-full h-fit p-12 flex flex-col gap-8 overflow-hidden">
          <div className="w-full h-fit flex flex-row gap-12">
            <div className="w-full h-full">
              <h4 className="w-96 h-fit text-5xl leading-[120%] font-semibold">EXPLORE YOUR ESSENTIAL STYLE PILARS</h4>
            </div>
            <p className="w-full h-auto flex items-center text-base font-medium leading-[120%] text-[#757575] text-justify">
          ...
          <div className="w-full h-fit flex flex-row gap-12">
            ...
            <div className="w-full h-fit flex flex-col gap-12">
              <div className="w-full h-[720px] flex flex-col justify-between">
                ...
                <button className="w-full py-2 text-white bg-black justify-center text-base font-medium 
                hover:bg-transparent hover:text-black border border-black duration-300 transition-all cursor-pointer">View More</button>
              </div>
            </div>
          </div>
        </section>
        <section ref={sectionRefs[1]} className="w-full h-fit bg-black text-white p-12 flex flex-row gap-12">
          <div className="w-full h-fit flex flex-col gap-32">
            <h5 className="w-full text-5xl leading-[120%] font-semibold">
              <span className="block">DISCOVER VESTE</span>
              <span className="block">ESSENCE</span>
            </h5>
            <div className="w-full h-fit flex flex-col gap-8">
              <p className="w-full h-fit leading-[140%] text-base font-normal tracking-[0px] text-justify">
              ...
              <div className="w-full h-fit flex flex-row gap-12">
                ...
                <div className="w-[420px] h-auto flex flex-col justify-between">
                  <h6 className="w-full h-fit leading-[110%] text-xl font-semibold">
        ...
        <section ref={sectionRefs[2]} className="w-full h-fit bg-black text-white p-12 flex items-end flex-row justify-between">
          <h6 className="w-[800px] text-5xl leading-[120%] font-semibold">
              Connect with our definitive perspective on style and culture.
          </h6>
          <button className="w-fit h-fit px-10 py-2 text-black bg-white justify-center text-base font-medium 
          hover:bg-black hover:text-white border border-white duration-300 transition-all cursor-pointer">Learn More</button>
        </section>
        ...
        <footer className="w-full h-fit bg-black text-white p-12 flex flex-col gap-10">
          <div className="w-full h-fit flex flex-row justify-between">
            <div className="w-full h-auto flex flex-col justify-between">
              <h6 className="text-5xl leading-[120%] font-semibold">Veste</h6>
            ...
            <div className="w-fit h-fit flex flex-row gap-10">
              ...
              <div className="w-36 h-fit flex flex-col gap-5">
